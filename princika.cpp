...
void question_bank_class::start_quiz()
    ...
    void question_bank_class:: result_marksheet()
    {
        ...
        case 2:
            ...
            {
            case 1:
                cout << "   Subject : Oops                                Topic:Class and Objects" << endl;
                subject_choosed_name = "OOPS";
                topic_choosed_name = "Topic:Class and Objects";
                break;
            case 2:
                cout << "   Subject : Oops                                Topic:Abstraction" << endl;
                subject_choosed_name = "OOPS";
        ...
        case 3:
            ...
            {
            case 1:
                cout << "  Subject : BEEE                                  Topic:D.C. Circuits" << endl;
                subject_choosed_name = "BEEE";
                topic_choosed_name = "D.C. Circuits";

                break;
            case 2:
                cout << "   Subject : BEEE                                  Topic:Capacitors" << endl;
                subject_choosed_name = "BEEE";
        ...
        cout << "                               Marksheet Of Second Semester Exame                                  " << endl;
        cout << "                                                                                                   " << endl;
        sleep(1);
        cout << "              *                                                                                   * " << endl;
        cout << "              *                                                                                   * " << endl;
        ...
        cout << "              *                                                                                   * " << endl;
        cout << "              *                                                                                   * " << endl;
        cout << "                            Subject Of  Exame :          " << subject_choosed_name << "            " << endl;
